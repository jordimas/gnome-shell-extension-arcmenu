...
|-----|-----|-----|-----|
||![](https://gitlab.com/LinxGem33/Neon/raw/master/artwork/done.svg.png)|![](https://gitlab.com/LinxGem33/Neon/blob/master/artwork/in-progress.png)|![](https://gitlab.com/LinxGem33/Neon/blob/master/artwork/refused.svg.png)|
|Explanation|Active means the developer is maintaining and offering support.|Unavailable means that the developer is no longer adding code of offering support but is still excepting pull requests.|Inactive means there is no code being added or support offered and is no longer accepting pull requests.|
